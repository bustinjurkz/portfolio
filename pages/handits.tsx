    ...
    <PageDetailsStyle>
      ...
      <div className="project-container" id="start">
        <section className="intro">
          ...
          <div className="snapshot">
            <div className="tagline">
              Explore strange worlds & solve puzzles as a group of bandits with
              bold hands!
            </div>
            <div className="container">
              <div className="description">
                ...
                <p>
                  ...
                  manipulate the handit&apos;s hand and toss, grab, snap, slap,
                  pull, wave, push, and shoot in order to safely collect hidden
                  relics.
                </p>
              </div>
              <div className="notes">
        ...
        <div className="image-container">
          ...
          />
          <div className="label">
            Level 1 - both players must reach the end. The solution is to hoist
            your partner over the middle block so they detonate the TNT. The TNT
            makes the boulder fall, so one player must grab the torch and set
            fire to the barrel to expose the little safety ditch beforehand.
          </div>
        </div>
        ...
        <div className="image-container">
          ...
          />
          <div className="label">
            Grabbing and throwing physics. More wonkier than anticipated but it
            added an extra layer of hilarity. The goal was to make it as
        ...
        <section>
          ...
          <ListStyle>
            <ul>
              ...
              <li>
                Game design principles were studied. The creation of an on-going
                Game Design Document helped to organize our many ideas.
              </li>
              <li>
                The first deliverable was a Proof of Concept involving the main
                mechanics. It was then subjected to playtesting in order to
                continuously refine the game.
              </li>
              <li>
          ...
          <ListStyle>
            <ul>
              <li>
                ...
                provides me with a great creative outlet and fuller utilization
                of my skills, since I also love creating music.
              </li>
              <li>
                It is easier to make it as an actor than a video game developer.
                The amount of respect I have for those grinding it out in the
                gaming industry is astronomical.
              </li>
              <li>
