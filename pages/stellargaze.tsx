      ...
      <div className="project-container" id="start">
            ...
            <div className="container">
              <div className="description-container">
                <div className="description">
                  ...
                  the nightly weather forecasts of humidity and cloud coverage.
                  It is made for both space enthusiasts and casual observers of
                  the sky. This was my first ever experience with React and my
                  first real project after completing my Bachelors in Computer
                  Science. I decided to become a professional web developer
                  after; I had so much fun working on this with close friends at
                  cafes all throughout Hamilton, Ontario. There are future plans
                  to make this an experiential meditative stargazing experience
                  using React Native and my better skills after working 3 years
                  in the industry.
                </div>
                <div className="visit">
                  <Button
        ...
        <section className="technical">
          ...
          <div className="content">
            <p>
              ...
              visibility. A score of 80% or greater represents good visibility.
            </p>
            <p>
            ...
            <SpecialListStyle>
              ...
              This Day/Night Band image captures the average radiance values of
              North America, Australia, and New Zealand. The pixel values we
              extract correspond to a number on the Bortle scale, which gives an
              approximate measure of the night sky&apos;s brightness at a
              particular location.
            </SpecialListStyle>
            <SpecialListStyle>
            ...
            <SpecialListStyle>
              ...
              individually was infeasible, as well as not financially viable. As
              a result, a k-means clustering algorithm was used to cluster
        ...
        <div className="image-container">
          ...
          <div className="label">
            ...
            Stored parks are coloured according to light pollution - the lighter
          ...
          <ListStyle>
            <ul>
              <li>
                ...
                principles (state...) to the front-end made me thankful I got a
                degree prior.
              </li>
              <li>
                I was shocked that no one has attempted to create a visibility
                metric with respect to naked-eye stargazing. Functions were used
                based on 4 factors: light pollution, moon illumination, humidity
                %, and cloud coverage. For example, if the moon illumination at
                a given time is over 50%, it will assign a score of 0 to the
                moon. This means that since the moon illumination is high,
                obfuscating the stars, it will result in a lower overall score
                for that park
              </li>
              <li>
              ...
              <li>
                ...
                proud that this was my first ever hobby project, I am not
